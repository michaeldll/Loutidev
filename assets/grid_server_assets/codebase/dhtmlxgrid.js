                ...
                n.onreadystatechange = function () {
                    if ((n.readyState == 4) || (i == true && n.readyState == 3)) {
                        if (n.status != 200 || n.responseText == "") {
                            e.reject(n);
                            if (!dhx4.callEvent("onAjaxError", [{xmlDoc: n, filePath: c, async: h}])) {
                                return
                            }
                        }
...
function dhtmlXCalendarObject(f, l) {
    ...
    j.onclick = function (n) {
        ...
        if (a.className && a.className == "dhtmlxcalendar_label_today") {
            var o = new Date();
            o = new Date(o.getFullYear(), o.getMonth(), o.getDate(), e._activeDate.getHours(), e._activeDate.getMinutes(), e._activeDate.getSeconds(), e._activeDate.getMilliseconds());
            e.setDate(o);
            e._updateInp();
            ...
            for (var C = 0; C <= 7; C++) {
                if (C == 0) {
                    ...
                    if (A >= 52 && this.conf.ws_first == true && this._activeMonth.getMonth() == 0) {
                        ...
                        if (A > 52 && this._activeMonth.getMonth() == 11) {
                            var p = this.getWeekNumber(new Date(t.getFullYear() + 1, 0, 1));
                            if (p == 1) {
                                A = 1
                            }
                        }
    ...
    this.getWeekNumber = function (n) {
        ...
        o.setDate(n.getDate() + (4 - m));
        var a = o.getFullYear();
        var p = Math.round((o.getTime() - new Date(a, 0, 1).getTime()) / 86400000);
        return 1 + Math.floor(p / 7)
    };
...
dhtmlXCombo.prototype.modes.option = {
    ...
    setText: function (c, d, b) {
        c._conf.text = d;
        var a = (typeof(d) == "object" ? window.dhx4.template(c._tpl.option, this.replaceHtml(c._conf.text, b), true) : window.dhx4.trim(this.replaceHtml(c._conf.text, b) || ""));
    ...
    replaceHtml: function (e, d) {
        ...
        if (typeof(e) == "object") {
            var c = {};
            for (var b in e) {
                c[b] = (d[b] == true ? e[b] : this.replaceHtml(e[b]))
            }
        } else {
            var c = (e || "").replace(/[\<\>\&\s]/g, function (a) {
                switch (a) {
                    case"<":
                        return "&lt;";
                    case">":
...
dhtmlXCombo.prototype.modes.checkbox = {
    ...
    render: function (b, c) {
        ...
        b._conf = {value: c.value, css: "", checked: window.dhx4.s2b(c.checked)};
        b.className = "dhxcombo_option";
        var a = {};
        if (c.multicol == true) {
            c.text.checkbox = "<div class='" + String(this.image_css).replace("#state#", (b._conf.checked ? "1" : "0")) + "'></div>&nbsp;";
            a.checkbox = true;
            b.innerHTML = "<div class='" + dhtmlXCombo.prototype.modes.option.option_css + "'></div>"
        } else {
            b.innerHTML = "<div class='" + String(this.image_css).replace("#state#", (b._conf.checked ? "1" : "0")) + "'></div><div class='" + this.option_css + "'>&nbsp;</div>"
        }
        if (c.css != null) {
...
function dhtmlXMenuObject(e, f) {
    ...
    this.conf = {
        ...
        of_dtime: 20,
        of_dstep: 3,
        of_ah: {dhx_skyblue: 24, dhx_web: 25, dhx_terrace: 27, material: 25},
        of_ih: {dhx_skyblue: 24, dhx_web: 24, dhx_terrace: 24, material: 30},
        tm_sec: 400,
        tm_handler: null,
        dload: false,
        dload_url: "",
...
dhtmlXMenuObject.prototype._renderToplevelItem = function (h, g) {
    ...
    a.onclick = function (m) {
        ...
        var j = {ctrl: m.ctrlKey, alt: m.altKey, shift: m.shiftKey};
...
dhtmlXToolbarObject.prototype._removeItem = function (e) {
    ...
    if ({button: 1, buttonTwoState: 1}[c] == 1) {
        if (window.dhx4.isIE) {
...
dhtmlXToolbarObject.prototype._buttonSelectObject = function (d, g, f) {
    ...
    this.addListOption = function (n, m, j, l, h) {
        ...
        var i = {id: n, type: j, text: l, img: h};
...
dhtmlXGridObject.prototype = {
    ...
    adjustColumnSize: function (n, c) {
        if (this._hrrar && this._hrrar[n]) {
            return
        }
        this._notresize = true;
        var e = 0;
        this._setColumnSizeR(n, 20);
        for (var g = 1; g < this.hdr.rows.length; g++) {
            var q = this.hdr.rows[g];
            q = q.childNodes[(q._childIndexes) ? q._childIndexes[n] : n];
            if ((q) && ((!q.colSpan) || (q.colSpan < 2)) && q._cellIndex == n) {
                if ((q.childNodes[0]) && (q.childNodes[0].className == "hdrcell")) {
                    q = q.childNodes[0]
                }
                e = Math.max(e, q.scrollWidth)
            }
        }
        var f = this.obj.rows.length;
        var p = 0;
        var s = this.cellType._dhx_find("tree");
        var o = document.createElement("DIV");
        o.className = "dhx_grid_adjust";
        o.style.cssText = "width:auto;height:auto;visibility:hidden; position:absolute; top:0px; left:0px; overflow:hidden; white-space:nowrap;";
        document.body.appendChild(o);
        for (var h = 1; h < f; h++) {
            var r = this.obj.rows[h];
            var b = n;
            if (!this.rowsAr[r.idd]) {
                continue
            }
            if (r._childIndexes) {
                if (r._childIndexes[n] == r._childIndexes[n + 1]) {
                    continue
                }
                b = r._childIndexes[n]
            }
            if (!r.childNodes[b] || r.childNodes[b]._cellIndex != n) {
                continue
            }
            o.innerHTML = (r.childNodes[b].innerText || r.childNodes[b].textContent || "");
            p = o.offsetWidth;
            if (this._h2 && n == s) {
                p += this._h2.get[r.idd].level * 22
            }
            if (p > e) {
                e = p
            }
    ...
    getStateOfView: function () {
        if (this.pagingOn) {
            var d = (this.currentPage - 1) * this.rowsBufferOutSize;
            return [this.currentPage, d, Math.min(d + this.rowsBufferOutSize, this.rowsBuffer.length), this.rowsBuffer.length]
        }
        ...
        if (this.multiLine) {
            ...
            b = 0;
            while (c >= 0) {
                c -= this.rowsCol[b] ? this.rowsCol[b].offsetHeight : this._srdh;
                b++
            }
            b--;
            ...
            a = 0;
            while (c >= 0) {
                c -= this.rowsCol[b + a] ? this.rowsCol[b + a].offsetHeight : this._srdh;
                a++
            }
        }
...
dhtmlXGridObject.prototype.getRowData = function (e) {
    var b = {};
    var a = this.getColumnsNum();
    for (var c = 0; c < a; c++) {
        var d = this.getColumnId(c);
        if (d) {
            b[d] = this.cells(e, c).getValue()
        }
    }
    return b
};
dhtmlXGridObject.prototype.setRowData = function (e, c) {
    var a = this.getColumnsNum();
    for (var b = 0; b < a; b++) {
        var d = this.getColumnId(b);
        if (d && c.hasOwnProperty(d)) {
            this.cells(e, b).setValue(c[d])
        }
    }
};
...
function eXcell_dyn(a) {
    ...
    this.getValue = function () {
        ...
        var c = this.cell.firstChild.childNodes[1].innerHTML.toString()._dhx_trim();
...
dhtmlXGridObject.prototype.collectValues = function (e) {
    ...
    this.dma(false);
    var m = (this.combos[e] || (this._col_combos && this._col_combos[e] ? this._col_combos[e] : ((this._sub_trees && this._sub_trees[e]) ? this._sub_trees[e][0] : false)));
    for (var j in l) {
        if (l[j] === true) {
            if (m) {
                if (m.get && m.get(j)) {
                    ...
                    if (m.getOption && m.getOption(j)) {
                        ...
                        if (m.getItemText) {
                            var p = m.getItemText(j);
                            var r = this._sub_trees[e][1] = this._sub_trees[e][1] || {};
                            r[p] = j;
                            j = p
                        }
                    }
...
dhtmlXGridObject.prototype.selectBlock = function (d, c, b, a) {
    ...
    this._CreateSelection(c, d);
    this._selectionArea = this._RedrawSelectionPos(this.cells2(c, d).cell, this.cells2(a, b).cell);
    this._ShowSelection()
};
...
eXcell_dhxCalendar.prototype.edit = function () {
    ...
    var c = 0;
    if (!window.innerHeight || (b[1] + this.grid._grid_calendarA.base.offsetHeight + this.cell.offsetHeight < window.innerHeight)) {
        c = b[1] + this.cell.offsetHeight
    } else {
        c = b[1] - (this.grid._grid_calendarA.base.offsetHeight)
    }
    var d = b[0];
    if (window.innerWidth && (d + this.grid._grid_calendarA.base.clientWidth + this.cell.offsetWidth > window.innerWidth)) {
        d = window.innerWidth - this.grid._grid_calendarA.base.clientWidth
    }
    this.grid._grid_calendarA.setPosition(d, c);
    ...
    for (var d = 0; d < j.length; d++) {
        ...
        if (this.rowsAr[a] && this.rowsAr[a].tagName != "TR") {
            ...
            if (this.rowsAr[a]) {
                ...
                if (this._refresh_mode[1]) {
                    var f = {idd: a, data: h, _parser: this._process_json_row, _locator: this._get_json_data};
                    var b = this.rowsBuffer.length;
                    if (this._refresh_mode[1] == "top") {
...
dhtmlXGridObject.prototype._parseOptionsJson = function (c) {
    if (c.coll_options) {
        for (var b in c.coll_options) {
            var e = c.coll_options[b];
            var d = this.getColIndexById(b);
            var f;
            if (this.cellType[d] == "combo") {
                var f = this.getColumnCombo(d);
                f.addOption(e)
            } else {
                if (this.cellType[d].indexOf("co") == 0) {
                    var f = this.getCombo(d);
                    for (var a = 0; a < e.length; a++) {
                        f.put(e[a].value, e[a].label)
                    }
                }
            }
        }
...
dhtmlXGridObject.prototype._process_tree_json = function (d, e, b, g) {
    ...
    if (g == "js") {
        ...
        for (var c = 0; c < e.length; c++) {
            ...
            f.buff = {idd: h, data: e[c], _parser: this._process_js_row, _locator: this._get_js_data};
            if (e[c].open) {
                f.state = "minus"
            }
        ...
        if (e.rows) {
            for (var c = 0; c < e.rows.length; c++) {
                var h = e.rows[c].id;
                var f = this._h2.add(h, b);
                f.buff = {idd: h, data: e.rows[c], _parser: this._process_json_row, _locator: this._get_json_data};
                if (e.rows[c].open) {
                    f.state = "minus"
                }
                this.rowsAr[h] = f.buff;
            ...
            if (this._tMode == "POST") {
                ...
                if (this._tMode == "JSON") {
                    ...
                    dhx4.ajax.query({
                        ...
                        headers: this._headers,
                        callback: j,
                        data: JSON.stringify({id: f, action: g, data: i})
                    })
                } else {
                    if (this._tMode == "REST") {
                        ...
                        dhx4.ajax.query({url: c, method: a, headers: this._headers, data: i, callback: j})
                    }
                }
            }
        }
